CREATE OR REPLACE TABLE
  `${PROJECT_ID}.${DATASET_ID}.reservation_utilization_30_days` AS
...
WHERE
  ...
  jbo.creation_time BETWEEN TIMESTAMP_SUB(TIMESTAMP("2020-07-15 23:59:59.000 UTC"), INTERVAL 31 DAY)
  AND TIMESTAMP("2020-07-15 23:59:59.000 UTC")
  AND jbo.end_time BETWEEN TIMESTAMP_SUB(TIMESTAMP("2020-07-15 23:59:59.000 UTC"), INTERVAL 30 DAY)
  AND TIMESTAMP("2020-07-15 23:59:59.000 UTC")
GROUP BY
  reservation_id,
  lsc.slot_capacity
